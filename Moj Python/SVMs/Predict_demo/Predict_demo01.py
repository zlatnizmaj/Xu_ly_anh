...
get_data('googleMau.csv')  # calling get_data method by passing the csv file to it
print(dates)
print(prices)
print("\n")

show_plot(dates, prices)
# image of the plot will be generated.
# Save it if you want and then Close it to continue the execution of the below code.
